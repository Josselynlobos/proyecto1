                ...
                <table class=" table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="#" class="btn btn-warning btn-sm eliminar" data-bs-id="<?php echo $_id;?>" data-bs-toggle="modal" data-bs-target="#eliminaModal">Eliminar</a></td>
                        </tr>
        ...
        function actualizaCantidad(cantidad, id){
            ...
            .then(data=>{
                if(data.ok){
                    ...
                    let currencySymbol = '<?php echo MONEDA;?>';
                    document.getElementById('total').innerHTML = currencySymbol + formattedTotal;
                }
            });
